...
describe('showIt', function () {
  it('should spec', function () {
    document.documentElement.innerHTML = fs.readFileSync(fixture('doc.html'), 'utf-8')
    ...
    showIt({
      ...
      text:
        '.ct-editor-wrapper .pm-body-wrapper p, .ct-editor-wrapper .pm-body-wrapper .ct-code, .ct-editor-wrapper .pm-body-wrapper li'
    })
  })
})
